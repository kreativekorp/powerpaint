...
public class ToolOptionsUI extends JPanel implements ToolContextListener {
	...
	private static JPanel makeSection(String label, JComponent content, boolean mini) {
	...
	private static JPanel makeSectionStack(Collection<JComponent> rows, boolean mini) {
