...
public class FilterMenuItem extends CKPMenuItem {
	private static final long serialVersionUID = 1L;
	
	protected Filter filter;
	
	public FilterMenuItem(Filter filter, CKPApplication app, CKPDocument doc) {
		super(null, app, doc);
		setEnabled(doc != null);
		setText(filter.usesOptionForm() ? (filter.getName()+"...") : filter.getName());
		this.filter = filter;
	}
