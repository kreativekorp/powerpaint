...
public class LastFilterMenuItem extends CKPMenuItem {
	private static final long serialVersionUID = 1L;
	
	public LastFilterMenuItem(CKPApplication app, CKPDocument doc) {
		super("Filter.Last", app, doc);
		setEnabled(doc != null && doc.enableLastFilter());
		setText(
		...
		if (doc != null) {
			doc.getCanvasController().addCanvasControllerListener(new CanvasControllerListener() {
				public void canvasControllerEvent() {
					setEnabled(LastFilterMenuItem.this.doc.enableLastFilter());
					setText(
