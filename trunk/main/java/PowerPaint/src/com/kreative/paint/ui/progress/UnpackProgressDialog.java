...
public class UnpackProgressDialog extends JDialog implements Monitor {
	private static final long serialVersionUID = 1L;
	
	private DocumentIconProgressIndicator ind;
	private JLabel txt;
	
	public UnpackProgressDialog(Frame parent, int min, int max) {
		super(parent, UIUtilities.messages.getString("main.unpack.title"), false);
		ind = new DocumentIconProgressIndicator("PMZ", min, max, min);
		txt = new JLabel(UIUtilities.messages.getString("main.unpack.text"));
