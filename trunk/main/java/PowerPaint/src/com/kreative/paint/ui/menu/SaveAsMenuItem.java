...
public class SaveAsMenuItem extends CKPMenuItem {
	private static final long serialVersionUID = 1L;
	
	public SaveAsMenuItem(CKPApplication app, CKPDocument doc) {
		super("File.SaveAs", app, doc);
		setEnabled(doc != null);
	}
	
	public void actionPerformed(ActionEvent e) {
		doc.doSaveAs(null, null);
	}
}
