...
public class IntegerOptionSliderUI extends JSlider implements FormOptionUI {
	private static final long serialVersionUID = 1L;
	private IntegerOption o;
	private UpdateLock u = new UpdateLock();
	
	public IntegerOptionSliderUI(IntegerOption opt, boolean mini) {
		this.o = opt;
		setMinimum(o.getMinimum());
		setMaximum(o.getMaximum());
		setValue(o.getValue());
