...
public class DrawSurfaceGraphics extends Graphics2D {
	private DrawSurface d;
	private BufferedImage modelImage;
	private Graphics2D modelGraphics;
	
	public DrawSurfaceGraphics(DrawSurface d) {
		this.d = d;
	...
	public void addRenderingHints(Map<?, ?> hints) {
		System.err.println("Warning: Invocation of unsupported method DrawSurfaceGraphics.addRenderingHints");
		modelGraphics.addRenderingHints(hints);
	}

	@Override
	public void clip(Shape s) {
		System.err.println("Warning: Invocation of unsupported method DrawSurfaceGraphics.clip");
	...
	public void drawGlyphVector(GlyphVector g, float x, float y) {
		// TODO DrawSurfaceGraphics.drawGlyphVector(GlyphVector)
		System.err.println("Warning: Invocation of unimplemented method DrawSurfaceGraphics.drawString(GlyphVector, float, float)");
	}
	...
	public void drawString(AttributedCharacterIterator iterator, int x, int y) {
		// TODO DrawSurfaceGraphics.drawString(AttributedCharacterIterator)
		System.err.println("Warning: Invocation of unimplemented method DrawSurfaceGraphics.drawString(AttributedCharacterIterator, int, int)");
	}

	@Override
	public void drawString(AttributedCharacterIterator iterator, float x, float y) {
		// TODO DrawSurfaceGraphics.drawString(AttributedCharacterIterator)
		System.err.println("Warning: Invocation of unimplemented method DrawSurfaceGraphics.drawString(AttributedCharacterIterator, float, float)");
	}
	...
	public Object getRenderingHint(RenderingHints.Key hintKey) {
		System.err.println("Warning: Invocation of unsupported method DrawSurfaceGraphics.getRenderingHint");
		return modelGraphics.getRenderingHint(hintKey);
	}

	@Override
	public RenderingHints getRenderingHints() {
		System.err.println("Warning: Invocation of unsupported method DrawSurfaceGraphics.getRenderingHints");
	...
	public void setRenderingHint(RenderingHints.Key hintKey, Object hintValue) {
		if (!(hintKey == RenderingHints.KEY_ANTIALIASING || hintKey == RenderingHints.KEY_TEXT_ANTIALIASING))
			System.err.println("Warning: Invocation of unsupported method DrawSurfaceGraphics.setRenderingHint");
		modelGraphics.setRenderingHint(hintKey, hintValue);
	}

	@Override
	public void setRenderingHints(Map<?, ?> hints) {
		System.err.println("Warning: Invocation of unsupported method DrawSurfaceGraphics.setRenderingHints");
	...
	public void clipRect(int x, int y, int width, int height) {
		System.err.println("Warning: Invocation of unsupported method DrawSurfaceGraphics.clipRect");
		modelGraphics.clipRect(x, y, width, height);
	}

	@Override
	public void copyArea(int x, int y, int width, int height, int dx, int dy) {
		System.err.println("Warning: Invocation of unsupported method DrawSurfaceGraphics.copyArea");
		// nothing
	}

	@Override
	public Graphics create() {
		return new DrawSurfaceGraphics(d);
	}
	...
	public Shape getClip() {
		System.err.println("Warning: Invocation of unsupported method DrawSurfaceGraphics.getClip");
		return modelGraphics.getClip();
	}

	@Override
	public Rectangle getClipBounds() {
		System.err.println("Warning: Invocation of unsupported method DrawSurfaceGraphics.getClipBounds");
	...
	public void setClip(Shape clip) {
		System.err.println("Warning: Invocation of unsupported method DrawSurfaceGraphics.setClip");
	...
	public String toString() {
		return "com.kreative.paint.DrawSurfaceGraphics["+d+","+modelImage+","+modelGraphics+"]";
	}
}
